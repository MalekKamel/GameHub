...
public class RequestOptions {
    ...
    // Indicates offline mode supported
    var isOfflineSupported: Bool = true
    ...
    public class Builder {
        ...
        /// Toggle to support offline mode
        public func withOfflineSupport(_ value: Bool) -> Builder {
            options.isOfflineSupported = value
            return self
        }
